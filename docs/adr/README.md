...
| [0036](0036-domain-state-ownership-and-execution-model.md) | Own domain state by data category, assemble FIS-B one time, and state the execution and channel rules | Accepted |
