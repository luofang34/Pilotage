...
| Aircraft | Aircraft profile, loading, live engine and fuel state, and derived performance results | [ADR-0046](adr/0046-an-aircraft-domain-owns-configuration-performance-and-fuel.md) |
