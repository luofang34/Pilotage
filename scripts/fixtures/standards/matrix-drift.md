# SIM / NOT FOR FLIGHT — self-test fixture matrix (drifts from registry-good.toml)
#
# The STD-061 "Selected revision" cell still names the superseded AC 20-167A,
# while registry-good.toml selects AC 20-167B. The guard must FAIL this on
# generated-table drift.

| ID | Standard / reference | Selected revision | Authority status | Rationale |
| --- | --- | --- | --- | --- |
| STD-061 | [FAA AC 20-167B](https://www.faa.gov/regulations_policies/advisory_circulars/index.cfm/go/document.information/documentID/1044323) — EVS/EFVS/CVS | AC 20-167A (guidance) | `authority-accepted` | Stale selected revision. |
