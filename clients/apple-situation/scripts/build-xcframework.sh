...
package_root="$client_root/Packages/PilotageSituationCore"
cd "$ffi_root"
...
generated="$package_root/Sources/PilotageSituationCore/Generated"
headers=target/xcframework-headers
artifact="$package_root/artifacts/PilotageSituationFFI.xcframework"
