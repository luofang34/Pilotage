...
// fixtures/ directory (the codec owner's own tree, so they travel with the
// crate and arrive here at the pinned upstream rev) are generated by the
// upstream `cargo xtask gen-state-fixture` from the shared Rust posture
// fixtures and pinned by the Rust codec's own tests. This suite rebuilds the same
